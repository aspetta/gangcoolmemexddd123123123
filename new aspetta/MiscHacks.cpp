...
void CMiscHacks::Move(CUserCmd *pCmd, bool &bSendPacket)
{
	...
	// ale i tak ten resolver crashowal xD
...
void CMiscHacks::ChatSpamInterwebz()
{
	...
	if (wasSpamming)
	{
		...
		if (useSpace)
		{
			change_name ("™Jihad.win by DEDSEE, Faddd, w4ntdd");
			useSpace = !useSpace;
		}
		else
		{
			change_name("™Jihad.win");
			useSpace = !useSpace;
		}
	}
...
void CMiscHacks::ChatSpamDisperseName()
{
	...
	{
		SayInTeamChat("JEBAC DARKESTA CHLOPAKOW SPRZEDAL, W4NTDD MA USLUGI KAMIENIARSKIE, DEDSEE SPRZEDAJE KAMIENIE, AIMTUX BEST HEKE, MOLENDI HELP, w4ntdd: darkesta sie nie jebie darkesta sie napierdala, aimware best no spread cheat, jebac polakow jebane cebule, dzieki sinner za vps, XD, hahahhaha, wy kurwy, JIHAD.WIN BEST CHEAT");
	}
	else
	{
		SayInChat("JEBAC DARKESTA CHLOPAKOW SPRZEDAL, W4NTDD MA USLUGI KAMIENIARSKIE, DEDSEE SPRZEDAJE KAMIENIE, AIMTUX BEST HEKE, MOLENDI HELP, w4ntdd: darkesta sie nie jebie darkesta sie napierdala, aimware best no spread cheat, jebac polakow jebane cebule, dzieki sinner za vps, XD, hahahhaha, wy kurwy, JIHAD.WIN BEST CHEAT");
	}
