...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "steel.cc"); break;
		case 1:SetClanTag("         J", "Jihad.win"); break;
		case 2:SetClanTag("        Ji", "Jihad.win"); break;
		case 3:SetClanTag("       Jih", "Jihad.win"); break;
		case 4:SetClanTag("      Jiha", "Jihad.win"); break;
		case 5:SetClanTag("     Jihad", "Jihad.win"); break;
		case 6:SetClanTag("    Jihad.", "Jihad.win"); break;
		case 7:SetClanTag("   Jihad.w", "Jihad.win"); break;
		case 8:SetClanTag("  Jihad.wi", "Jihad.win"); break;
		case 9:SetClanTag(" Jihad.win", "Jihad.win"); break;
		case 10:SetClanTag("Jihad.win ", "Jihad.win"); break;
		case 11:SetClanTag("ihad.win  ", "Jihad.win"); break;
		case 12:SetClanTag("had.win   ", "Jihad.win"); break;
		case 13:SetClanTag("ad.win    ", "Jihad.win"); break;
		case 14:SetClanTag(".win     ", "Jihad.win"); break;
		case 15:SetClanTag("win      ", "Jihad.win"); break;
		case 16:SetClanTag("       ", "Jihad.win"); break;
		case 17:SetClanTag("        ", "Jihad.win"); break;
		case 18:SetClanTag("         ", "Jihad.win"); break;
		case 19:SetClanTag("          ", "Jihad.win"); break;
		}
		counter++;
	}
	break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	if (Menu::Window.MiscTab.OtherNoScopeBorder.GetState() && !strcmp("HudZoom", Interfaces::Panels->GetName(vguiPanel)))
		return;
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		Render::Text(10, 10, Color(119, 255, 0, 255), Render::Fonts::Menu, "");
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			Hacks::DrawHacks();
	...
	if (Menu::Window.VisualsTab.Active.GetState())
	{
		...
		else if (HandsStyle != 0 && strstr(ModelName, "arms"))
		{
			...
			else if (HandsStyle == 3)
			{
				...
				flColor[0] = (Menu::Window.ColorTab.WireframeColorR.GetValue() / 255.f); 
				flColor[1] = (Menu::Window.ColorTab.WireframeColorG.GetValue() / 255.f); 
				flColor[2] = (Menu::Window.ColorTab.WireframeColorB.GetValue() / 255.f); 
