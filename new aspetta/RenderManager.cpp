...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Elephant", 10, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tabs,"Untitled1", 50, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);// robimy ikony?
