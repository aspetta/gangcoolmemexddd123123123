...
#define UI_COL_TABTEXT      Color(235, 235, 235, 235)
...
void CGroupBox::Draw(bool hover)
{
	...
	//Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 6, m_iHeight - 4, Color(22, 22, 22, 255), Color(22, 22, 22, 255));
	Render::Clear(a.x, a.y, m_iWidth, m_iHeight, Color(0, 0, 0, 15));
	Vertex_t Verts2[4];
	Verts2[0].Init(Vector2D(a.x + 1, a.y + 1));
	Verts2[1].Init(Vector2D(a.x + m_iWidth - 2, a.y));
	Verts2[2].Init(Vector2D(a.x + m_iWidth - 6, a.y + 13));
	Verts2[3].Init(Vector2D(a.x + 4, a.y + 13));

	Render::PolygonOutline(4, Verts2, UI_COL_MAIN, UI_COL_SHADOW);

	int TextX = a.x + (m_iWidth / 2) - (txtSize.left / 2);
	Render::Text(TextX, a.y - (txtSize.bottom / 2) + 6, Color(32, 32, 32, 255), Render::Fonts::MenuBold, Text.c_str());

	Render::Outline(a.x, a.y, m_iWidth, m_iHeight, Color(48, 48, 48, 255));
	Render::Outline(a.x + 1, a.y + 1, m_iWidth - 2, m_iHeight - 2, Color(0, 0, 0, 255));
...
void CGroupBox::PlaceLabledControl(CTab *Tab, CControl* control, std::string Label)
{
	int x = m_x + 16;
	int y = m_y + Items * 24;
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 5, Location, 9, Color(231, 183, 92, 255), Color(231, 183, 92, 255));
...
void CSlider2::Draw(bool hover)
{
	...
	//Render::Outline(a.x + 1, a.y + 6, m_iWidth - 2, 9, Color(48, 48, 48, 255));
	Render::GradientV(a.x, a.y + 5, m_iWidth, 9, Color(54, 54, 54, 255), Color(66, 66, 66, 255));
	Render::GradientV(a.x, a.y + 5, Location, 9, UI_COL_MAIN, UI_COL_MAIN);
	Render::Outline(a.x, a.y + 5, m_iWidth, 9, Color(0, 0, 0, 255));
...
void CComboBox::Draw(bool hover)
{
	...
	if (GUI.IsMouseInRegion(Region))
		//Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, 12, Color(30, 30, 30, 255), Color(40, 40, 40, 255));
	...
	if (Items.size() > 0)
	{
		...
		if (IsOpen)
		{
			Render::GradientV(a.x, a.y + 17, m_iWidth, Items.size() * 16, Color(30, 30, 30, 200), Color(40, 40, 40, 255));
